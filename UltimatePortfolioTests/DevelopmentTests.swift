...
: BaseTestCase
{
	...
	throws
	{
		...
		XCTAssertEqual(dataController.count(for: Project.fetchRequest()), 0, "There shouldn't be any projects.")
		XCTAssertEqual(dataController.count(for: Item.fetchRequest()), 0, "There shouldn't be any items.")
	}
